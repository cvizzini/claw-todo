...
public class AppUser : IdentityUser
{
    ...
    // null for super-admins (Administrator role), required for TenantAdmin and User
    public int? TenantId { get; set; }
    public Tenant? Tenant { get; set; }
}

public class TodoDbContext : Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityDbContext<AppUser>
{
